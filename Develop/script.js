...
if (!okay) {
  alert("Ready for me to generate a password for you?");
} else if (okay < 8 || okay > 128) {
  okay = parseInt(prompt("You must choose between 8 and 128"));
...
//4. ask the user if they want to use special charecter
  ...
  var validmNumber = confirm("Will this contain numbers?");
  var validCharacters = confirm("Will this contain special characters?");
  var lettersUppercase = confirm("Will this contain Uppercase letters?");
  var lettersLowercase = confirm("Will this contain Lowercase letters?");
};
